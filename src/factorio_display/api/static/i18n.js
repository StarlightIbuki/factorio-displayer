...
const DICT = {
  en: {
    ...
    "s3.allInOneNote": "Results are generated as independent pieces by default (assembled into a blueprint book when small). \"Video with sound\" is the legacy all-in-one single-blueprint path — not recommended for large videos.",
    "s3.power": "Power",
  ...
  "zh-CN": {
    ...
    "s3.outAudio": "仅音频",
    "s3.allInOneNote": "结果默认按独立部件生成(较小时自动合并为蓝图书)。\"视频(带声音)\"是旧的单蓝图 all-in-one 路径——不推荐用于大视频。",
    "s3.power": "供电",
