...
const DICT = {
  en: {
    ...
    "auth.anonWarning": "You are not signed in — your uploaded media and generated blueprints are public and may be visible to other users. Sign in to keep them private.",
    "auth.anonWarningModal": "While signed out, your uploads and blueprints are public.",
    "auth.loginRequired": "Sign-in is required to upload on this server.",
    ...
    "home.filterEmpty": "No jobs with this status yet.",
    ...
    "s2.timelineHint": "Drag a block to align it, drag its edges to trim or extend it, or click to edit precise start/end, duration and timing mode below.",
    "s2.railVideo": "Video",
    "s2.railAudio": "Audio",
    "s2.pos": "Pos (s)",
    "s2.in": "In (s)",
    ...
    "s2.mode": "Mode",
    "s2.modeCut": "Cut",
    "s2.modeFast": "Fast play",
    "s2.modeRepeat": "Repeat",
    "s2.modeFreeze": "Freeze at end",
    "s2.modeSlow": "Slow play",
    "s2.edit": "Edit…",
    ...
    "s3.allInOneNote": "Results are generated as independent pieces by default (assembled into a blueprint book when small). \"Video with sound\" encodes the audio as separate pieces — no single giant merged blueprint (the legacy all-in-one, not recommended).",
    "s3.power": "Power",
    ...
    "viewer.urlHint": "Paste a blueprint string, or a URL (http/https) pointing at a raw blueprint string.",
    // report a bug
    "report.title": "Report a bug",
    "report.details": "Issue details",
    "report.hint": "Describe the problem — what you expected vs what happened, the media you used, etc. The job's blueprint and input files are saved with the report.",
    ...
    "jobs.previewTitle": "Final media preview",
    ...
    "jobs.reportBug": "Report bug",
    "jobs.reportBugTitle": "Save this job's blueprint and inputs for bug reporting (uploads are kept long-term)",
    // result panel
    "result.copy": "Copy",
    ...
    "result.inspectTitle": "Open the blueprint inspector (string / parts list / preview)",
    "result.pieces": "pieces",
    "result.book": "Blueprint book",
    "result.pieceHint": "This job was split into independently-wireable pieces (default). If a book was generated, copy/import it first; otherwise import each piece and wire the matching connectors in game (red = data, green = time).",
    "result.preview": "Preview",
    "preview.showWires": "Show wires",
    "preview.modePreview": "Preview",
    "preview.modeAscii": "ASCII",
    "preview.clickHint": "Click an entity to see its configuration",
    "preview.config": "Configuration",
    "preview.zoomIn": "Zoom in",
    "preview.zoomOut": "Zoom out",
    "preview.zoomReset": "Reset zoom (100%)",
    "preview.colorRed": "red wire",
    "preview.colorGreen": "green wire",
    "preview.points": "{n} pt",
    "preview.legendWires": "Wires:",
    "preview.legendEntities": "Entities:",
    "inspect.position": "position",
    "inspect.facing": "facing",
    "inspect.condition": "condition",
    "inspect.output": "output",
    "inspect.first": "first signal",
    "inspect.second": "second",
    "inspect.comparator": "compare",
    "inspect.operation": "operation",
    "inspect.outputSignal": "output signal",
    "inspect.copyCount": "copy count from input",
    "inspect.signal": "signal",
    "inspect.count": "count",
    "inspect.quality": "quality",
    "inspect.mode": "mode",
    "inspect.combine": "combine",
    "inspect.volumeSignal": "volume signal",
    "inspect.volumeControlled": "volume controlled",
    "inspect.instrument": "instrument",
    "inspect.signals": "signals",
    "inspect.loadHint": "Ctrl/Cmd+Enter to load",
    "ent.decider-combinator": "decider combinator",
    "ent.arithmetic-combinator": "arithmetic combinator",
    "ent.selector-combinator": "selector combinator",
    "ent.constant-combinator": "constant combinator",
    "ent.programmable-speaker": "programmable speaker",
    "ent.small-lamp": "small lamp",
    "facing.north": "north",
    ...
    "t.bugReported": "Bug report submitted — the job's blueprint and inputs are kept on the server.",
    "t.bugReportFail": "Could not submit bug report: {msg}",
  ...
  "zh-CN": {
    ...
    "auth.cancel": "取消",
    "auth.continueGuest": "不登录继续",
    "auth.anonWarning": "你尚未登录——你上传的媒体和生成的蓝图是公开的，可能对其他用户可见。登录后即可保密。",
    "auth.anonWarningModal": "未登录状态下，你的上传文件和蓝图是公开的。",
    "auth.loginRequired": "此服务器需要登录后才能上传。",
    ...
    "s2.timeline": "时间线",
    "s2.timelineHint": "拖动片段以对齐，拖动边缘以裁剪或延长，或点击下方精确调整开始/结束、时长与播放模式。",
    "s2.railVideo": "视频",
    "s2.railAudio": "音频",
    "s2.pos": "位置(秒)",
    "s2.in": "入点(秒)",
    ...
    "s3.outAudio": "仅音频",
    "s3.allInOneNote": "结果默认按独立部件生成(较小时自动合并为蓝图书)。\"视频(带声音)\"会把音频编码为独立部件——不再生成单个巨型合并蓝图(旧 all-in-one，不推荐)。",
    "s3.power": "供电",
    ...
    "viewer.urlHint": "可粘贴蓝图字符串，或粘贴指向原始蓝图字符串的链接（http/https）。",
    // report a bug
    "report.title": "报告问题",
    "report.details": "问题详情",
    "report.hint": "请描述遇到的问题——期望结果与实际结果、使用的媒体等。任务蓝图与输入文件会随报告一并保存。",
    "report.comment": "描述",
    ...
    "jobs.cancelled": "已取消",
    "jobs.reportBug": "报告问题",
    "jobs.reportBugTitle": "保存此任务的蓝图与输入文件用于问题报告（输入文件将被长期保留）",
    // result panel
    "result.copy": "复制",
    "result.download": "下载",
    "result.view": "查看",
    ...
    "result.inspectItem": "查看部件列表",
    "result.ascii": "调试 ASCII",
    "result.inspect": "检查",
    "result.inspectTitle": "打开蓝图检查器（字符串 / 部件列表 / 预览）",
    "result.preview": "预览",
    "preview.showWires": "显示连线",
    "preview.modePreview": "预览",
    "preview.modeAscii": "ASCII",
    "preview.clickHint": "点击部件查看其配置",
    "preview.config": "配置",
    "preview.zoomIn": "放大",
    "preview.zoomOut": "缩小",
    "preview.zoomReset": "重置缩放 (100%)",
    "preview.colorRed": "红色连线",
    "preview.colorGreen": "绿色连线",
    "preview.points": "{n} 点",
    "preview.legendWires": "连线：",
    "preview.legendEntities": "部件：",
    "inspect.position": "位置",
    "inspect.facing": "朝向",
    "inspect.condition": "条件",
    "inspect.output": "输出",
    "inspect.first": "第一信号",
    "inspect.second": "第二项",
    "inspect.comparator": "比较",
    "inspect.operation": "运算",
    "inspect.outputSignal": "输出信号",
    "inspect.copyCount": "复制输入数量",
    "inspect.signal": "信号",
    "inspect.count": "数量",
    "inspect.quality": "品质",
    "inspect.mode": "模式",
    "inspect.combine": "组合",
    "inspect.volumeSignal": "音量信号",
    "inspect.volumeControlled": "音量控制",
    "inspect.instrument": "乐器",
    "inspect.signals": "信号列表",
    "inspect.loadHint": "Ctrl/Cmd+Enter 加载",
    "ent.decider-combinator": "判断组合器",
    "ent.arithmetic-combinator": "运算组合器",
    "ent.selector-combinator": "选择组合器",
    "ent.constant-combinator": "常数组合器",
    "ent.programmable-speaker": "可编程扬声器",
    "ent.small-lamp": "小型灯",
    "facing.north": "北",
    "facing.northeast": "东北",
    "facing.east": "东",
    ...
    "t.bugReported": "已提交问题报告——任务的蓝图与输入文件已保存在服务器上。",
    "t.bugReportFail": "无法提交问题报告: {msg}",
